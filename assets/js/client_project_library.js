...
function videosGridViewDataCall(a, b, c) {
    $.ajax({
        url: site_url + "study_library/client/video_grid/" + (a.start + 1),
        method: "POST",
        data: a,
        async: true,
...
function video_search_by_title()
{
 ...
 var url = site_url + 'study_library/client/search_category_data';
...
function discussion_comments(selector,video_id,discussion_type){
  ...
  getComments: function(success, error) {
    $.get(site_url + 'study_library/client/get_video_comments/'+video_id+'/'+discussion_type,function(response){
      success(response);
    },'json');
  },
  postComment: function(commentJSON, success, error) {
    $.ajax({
      type: 'post',
      url: site_url + 'study_library/client/add_discussion_comment/'+video_id+'/'+discussion_type,
      data: commentJSON,
  ...
  putComment: function(commentJSON, success, error) {
    $.ajax({
      type: 'post',
      url: site_url + 'study_library/client/update_discussion_comment',
      data: commentJSON,
      success: function(comment) {
        comment = JSON.parse(comment);
        success(comment)
  ...
  deleteComment: function(commentJSON, success, error) {
    $.ajax({
      type: 'post',
      url: site_url + 'study_library/client/delete_discussion_comment/'+commentJSON.id,
      success: success,
      error: error
    });
  },

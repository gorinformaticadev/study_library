...
<div class="modal fade" id="add_library_categeory" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      ...
      <!-- Formulário para adicionar categoria. O atributo 'action' define para onde os dados serão enviados -->
      <?php echo form_open('admin/study_library/add_owner_operator_data',array('id'=>'category_form')); ?> 
           
      <div class="modal-body">
        <div class="row">
          <div class="col-md-8">
            <!-- Renderiza um campo de input para adicionar a categoria -->
...
<!-- Fim do modal para adicionar categoria -->

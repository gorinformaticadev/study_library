...
$(function() {
    ...
    var node = '<li role="presentation" class="project_tab_study_library"><a data-group="project_study_library" href="' + baseUrl + '" role="tab"><i class="fa fa-video-camera" aria-hidden="true"></i> Study library </a></li>';
